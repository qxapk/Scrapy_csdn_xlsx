...
if __name__ == '__main__':
    ...
    k = xlsxwriter.Workbook(r'C:\Users\aabb\Desktop\csdn_问答_' + qxtime + '.xlsx', {'strings_to_urls': False, 'constant_memory': True})
    # 为显式钱的单元格添加数字格式
    ...
    fx = open("shuju1.txt", 'r', encoding='utf-8')  # 返回一个文件对象
    a = fx.readline()
    while a:
        if (is_json(a) == True):
            obj = json.loads(a)
